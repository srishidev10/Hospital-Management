...
my $query2="SELECT * FROM out_patient";
...
while(@row=$sth2->fetchrow_array){
    ...
    $page1->stringc($font, 30, 200, 700, "PATIENT INFORMATION");
    $page1->stringc($font, 20, 50, 650, "PID");
    $page1->stringc($font, 20, 150, 650, "NAME");
    $page1->stringc($font, 20, 250, 650, "GUARDIAN");
    $page1->stringc($font, 20, 350, 650, "GENDER");
    $page1->stringc($font, 20, 450, 650, "AGE");
    my $i=1;
    my $x = 0;
    while($i<$g){
